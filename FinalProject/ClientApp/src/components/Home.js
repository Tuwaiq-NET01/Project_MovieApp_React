...
function Home(props) {
  ...
  const items = [
    {
      ...
      caption: (
        <h1
          className="neonText"
          style={{ textAlign: "center", fontSize: "40px", width: "250px" }}
        >
          Movies
        </h1>
      ),
  ...
  return (
    <div className="fade-me container myHome">
      <h1 className="neonText" style={{ textAlign: "center" }}>
      ...
      <h2
        style={{
          ...
          color: "white",
          textShadow:
            "-1px 0 2px black, 0 1px 2px black, 1px 0 2px black, 0 -1px 2px black, 1px 1px 2px black, 0 0 25px red, 0 0 5px red",
        }}
      >
        Choose Which Library You Want to Explore
      </h2>
